...
public class Update extends javax.swing.JDialog {
    ...
    private void PostalCodeKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PostalCodeKeyReleased
        if (!PostalCode.getText().isEmpty()
                && !isValidPostalCode(PostalCode.getText())) {
            JOptionPane.showMessageDialog(this, "Invalid postal code format.", this.getTitle(), JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void nifKeyTyped(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_nifKeyTyped
        if (!isNumber(evt.getKeyChar()) && evt.getKeyChar() != KeyEvent.VK_BACK_SPACE
                && evt.getKeyChar() != KeyEvent.VK_DELETE) {
            JOptionPane.showMessageDialog(this, "Type only numbers [0-9]", this.getTitle(), JOptionPane.ERROR_MESSAGE);
            evt.consume();
        }
    ...
    private void NumberPhoneKeyPressed(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_NumberPhoneKeyPressed
        ...
        if (!isNumber(evt.getKeyChar()) && evt.getKeyChar() != KeyEvent.VK_BACK_SPACE
                && evt.getKeyChar() != KeyEvent.VK_DELETE && evt.getKeyChar() != '-' && evt.getKeyChar() != '+'
    ...
    private void nameKeyPressed(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_nameKeyPressed
        if (!isLetter(evt.getKeyChar()) && evt.getKeyCode() != KeyEvent.VK_UP
            ...
            JOptionPane.showMessageDialog(this, "Type only uppercase or lowercase letters, hyphens, and whitespace.",
                    "UPdate - People v1.0", JOptionPane.WARNING_MESSAGE);
    ...
    private void emailKeyPressed(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_emailKeyPressed
        if (!calculateEmail(evt.getKeyChar()) && evt.getKeyCode() != KeyEvent.VK_UP
                ...
                && evt.getKeyCode() != KeyEvent.VK_RIGHT && evt.getKeyCode() != KeyEvent.VK_SHIFT
                && evt.getKeyCode() != KeyEvent.VK_BACK_SPACE && evt.getKeyCode() != KeyEvent.VK_DELETE) {
            JOptionPane.showMessageDialog(this, "Type only letters, digits and characters: @ . _ + & -",
                    "Update - People v1.0", JOptionPane.WARNING_MESSAGE);
